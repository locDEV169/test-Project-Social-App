...
function DetailCard(props) {
    ...
    const submitComment = () => {
        ...
        if (!check) {
            checkStatus
                // ? message.error("item card is be delete")
                ? navigate("/")
    ...
    return (
        <div className="home-page" style={{ margin: "0px auto" }}>
                ...
                <div className="detail-card">
                    ...
                    <div className="react">
                        <div className="react-tym">
                            ...
                            <div style={{ marginLeft: "7px", marginRight: "25px" }}>{reactTym}</div>
                        </div>
                ...
                <div className="post-cmt" style={{ marginBottom: "160px" }}>
                    <div className="social-footer">
                        ...
                        <Paper
                            id="form-search-cmt"
                            style={
                                cmtErr ? { border: "1px solid #F3115E" } : {}
                            }
                            component="form"
                        >
